package cn.gdeveloper.mapchat.helper;
 ...
 * @since JDK1.5
 */
public class DePinyinHelper {
	/** Ascii码表中第一个汉字：‘一’ */
	public static final char First_HANZI = '\u4E00';
	/** Ascii码表中第后一个汉字：‘龥’ */
	public static final char LAST_HANZI = '\u9FA5';

	private static DePinyinHelper mInstance;
	private static String[] PINYINS;
	private static final String NONE = "none";
	private static final String FILE_PATH = "unicode_to_hanyu_pinyin.dat";

	public static DePinyinHelper getInstance() {
		synchronized (DePinyinHelper.class) {
			if (mInstance == null) {
				mInstance = new DePinyinHelper();
			}
		}
		return mInstance;
	}

	public DePinyinHelper() {
